...
export function RightPanel() {
  return (
    <aside className="flex w-[272px] shrink-0 flex-col border-l border-edge bg-surface-1">
      <Tabs.Root defaultValue="clip" className="flex flex-1 flex-col overflow-hidden">
        ...
        <Tabs.Content value="clip" className="flex-1 overflow-y-auto">
          <PropertiesPanel />
        </Tabs.Content>

        <Tabs.Content value="audio" className="flex-1 overflow-y-auto">
          <AudioPanel />
        </Tabs.Content>
      </Tabs.Root>
    </aside>
